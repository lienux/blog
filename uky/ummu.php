...
<head> 
	<meta charset="utf-8" />
	<title>Ummu Khairiyah Yusna</title>
...
<body>
	<div id="level">
		<div id="content">
			<div id="gears">
				<img src="pp.jpeg" width="90%" style="border-radius: 30px;">
			...
			<div id="title">
				<h1>This page is currently in development.<br />by <a href="http://bocahganteng.com/" target="_blank"> bocahganteng.com</a></h1>
				<p>Hate and Love because of Allah</p>
			</div>
		</div>
	</div>
</body>
